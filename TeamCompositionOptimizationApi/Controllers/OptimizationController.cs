    ...
    public class OptimizationController : ControllerBase
    {
        ...
        public async Task<IActionResult> RecreateDatabase()
        {
            ...
            [
                ...
                new HelpPage(){Locale="ua", Name = "Оптимізація", Text = "Для оптимізації складу команди проєкту спочатку необхідно обрати компетенції, які повинна мати створена команда. Компетенція має три параметри: мінімальна відповідність кандидатів цій компетенції, можливе відхилення від цього значення та вага.\r\nПотім необхідно додати кандидатів. Кандидати мають відповідність кожній компетенції, можливе відхилення в більшу сторону, кількість робочих годин в тиждень та зарплату за годину.\r\nВ оптимізації є такі параметри, як порогове значення вірогідності відповідності кандидата компетенції, бюджет, трудовитрати на виконання проєкта в людиногодинах та час виконання проєкту в тижнях.\r\nПісля вибору компетенцій, кандидатів та параметрів оптимізації можна почати оптимізацію, натиснувши на відповідну кнопку.\r\nРезультатом оптимізації будуть варіанти можливих команд. Варіанти команд містять список кандидатів, вартість виконання проєкту, витрачені на нього людиногодини, максимальні значення відповідності кожній компетенції, сумма значень відповідності всіх компетенцій та сума максимальних значень кожної компетенції."},
